...
The previous subsection demonstrated that we can reproduce the gross statistical properties of human language using the LDA-DGP. In this section, 

HOLDING ALL ELSE CONSTANT B/C EXPERIMENTAL DESIGN
...
1. Stop words - several paths here
2. Eta is more important than has been appreciated
3. Alpha may be less important, but this goes against convention and other research. More exploraton necessary
4. Misspecifying K has the most consistent overall effect. Instinct of many to worry about it is right. Need future research to find principled ways of setting it. Simulations consistent with Zipf's law now may make this a reality. Future!
5. Some evidence for flat eta being good for fitting models. Again, more research is necessary.
