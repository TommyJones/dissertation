...
\author{Thomas W. Jones}    % Fullname
\title{Latent Dirichlet Allocation for Natural Language Statistics}     % Title Of Thesis
\DUTmonth{October}  % Name of the month of you defense
\DUTyear{2022}   % Year you are defending
\degree{Doctor of Philosophy}    % Your target degree, spelled out

  \advisor{Jason M. Kinser}   % Advisor's full name, degree
...
\NormalTok{pkg }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\StringTok{"dplyr"}\NormalTok{, }\StringTok{"ggplot2"}\NormalTok{, }\StringTok{"knitr"}\NormalTok{, }\StringTok{"bookdown"}\NormalTok{, }\StringTok{"devtools"}\NormalTok{, }\StringTok{"kableExtra"}\NormalTok{)}
...
\FunctionTok{library}\NormalTok{(dragondown)}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{include\_graphics}\NormalTok{(}\AttributeTok{path =} \StringTok{"figure/drexel{-}logo.pdf"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
\begin{figure}
\centering
...
\ControlFlowTok{if}\NormalTok{(}\SpecialCharTok{!}\FunctionTok{require}\NormalTok{(dragondown))}
\NormalTok{  devtools}\SpecialCharTok{::}\FunctionTok{install\_github}\NormalTok{(}\StringTok{"tbradley1013/dragondown"}\NormalTok{)}
\FunctionTok{library}\NormalTok{(dragondown)}
\end{Highlighting}
\end{Shaded}
