...
```{r tlda-mean-var, fig.width = 5, fig.height = 3, fig.cap = "P-values assessing convergence for each value of a with the mean in read (top) and the variance in blue (bottom)."}
