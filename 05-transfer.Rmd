...
One other area I leave for future study is using tLDA to build large pre-trained language models, as is common with deep learning transformers like BERT and the GPT family. This is similarly possible in principle. However, the Gibbs algorithm used for this paper makes building such large models computationally infeasible. Algorithms exist for scaling LDA estimates to "web-scale" data,  such as [@chen2015warplda], which can be used to implement tLDA in the future.
