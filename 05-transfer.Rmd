...
Step 1 uses the relationship in (\ref{eq:priorweight}), above. Step 2 uses a standard prediction method for LDA models. The _tidylda_ implementation uses a dot-product prediction described in Appendix 1 for speed. MCMC prediction would work as well.
