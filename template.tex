...
\usepackage{mathptmx}
\usepackage{etoolbox}%
%\BeforeBeginEnvironment{figure}{\addvspace{1.5cm}}
\AtBeginEnvironment{figure}{\vspace{1.5cm}}
\AfterEndEnvironment{figure}{\addvspace{1.5cm}}
...
\newcommand{\CSLRightInline}[1]{\parbox[t]{\linewidth - \csllabelwidth -0.25in}{#1}\break}
