...
\seconddeg{$seconddeg$}
\seconddegschool{$seconddegschool$}
\seconddegyear{$seconddegyear$}

\firstdeg{$firstdeg$}
\firstdegschool{$firstdegschool$}
\firstdegyear{$firstdegyear$}
...
\thirdmember{$thirdmember$}

\fourthmember{$fourthmember$}

\fifthmember{$fifthdmember$}
