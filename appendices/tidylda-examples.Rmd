# Appendix [X]: _tidylda_ Code Examples
...
posterior_theta_1 <- posterior(lda2, matrix = "theta", which = 1, times = 100)
...
posterior_beta_1 <- posterior(lda2, matrix = "beta", which = 1, times = 100)
