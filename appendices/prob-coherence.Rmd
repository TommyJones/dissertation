...
3. If $P(x_{j,k} = 1 | x_{i,k} = 1) < P(x_{j,k} = 1)$, then word $j$ is less present than average in conexts that contain word $i$. LDA is unlikely to find strong negative co-occurrences. In practice, negative values tend to be near zero.
